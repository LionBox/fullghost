...
coreHelpers.math = require('./math');
coreHelpers.everOther = require('./everOther');
coreHelpers.ifeven = require('./ifeven');
...
registerHelpers = function (adminHbs) {
    ...
    registerThemeHelper('math', coreHelpers.math);
    registerThemeHelper('everOther', coreHelpers.everOther);
